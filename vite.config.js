  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // NOTE: blog inputs temporarily removed — the blog/ folder isn't
        // committed to git yet, so referencing it broke the CI build. To ship
        // the blog: `git add blog/` (+ scripts/) then re-add these inputs.
      },
      output: {
        manualChunks: {
          three: ['three'],
